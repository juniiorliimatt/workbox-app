...
1. **Código / Ação primeiro**: Nenhuma saudação ou preâmbulo antes do bloco de código, comando ou diff. Aplique as modificações diretamente nos arquivos sempre que solicitado — exceto operações destrutivas ou irreversíveis, que seguem protocolo padrão de confirmação.
